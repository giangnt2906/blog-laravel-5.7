...
<div class="form-group ">
    ...
    <img id="img" src="/storage/cover_images/<?php echo $post->cover_image;?>" alt="your image" style="height:270px; width:480px;" />
</div>
...
<script>
    function readURL(input) {
        ...
        if (input.files && input.files[0] && (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
            ...
            $('#img').attr('src', '/storage/cover_images/<?php echo $post->cover_image?>');
        }
    }
</script>
{!! Form::close() !!}
